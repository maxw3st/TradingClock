...
the app. Source code is available in the src folder.
...
background, the other has a black background. I don't as yet have a certificate signing license, so the app will probably trigger security warnings and the JNLP launch feature won't work. The clock can be started by double clicking the .jar 
